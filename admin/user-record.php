                      ...
                      <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                        <thead>
                         ...
                         <th width="7%">country</th>
                            <!--<th width="9%">State</th>
                            <th width="7%">Grade Score</th>
                            <th width="7%">Proficiency test</th> -->
                            <th width="8%">Photo</th>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr class="gradeX">
                              ...
                              <td>
                                <div align="center"><?php echo $row['grade_score']; ?></div>
                              </td>
                              <td>
                                <div align="center"><?php echo $row['proficiency_test']; ?></div>
                              </td> -->
                              <td>
