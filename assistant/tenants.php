						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<b>List of Tenant</b>
									<span class="float:right"><button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" data-toggle="modal" data-target="#add_tenant">
								...
								<div class="card-body">
									<table class="table table-condensed table-bordered table-hover">
										...
										<tbody>
											<?php
											$i = 1;
											$tenant = $conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.house_no,h.description,h.price FROM tenants t inner join houses h on h.id = t.house_id where t.status = 1 order by h.house_no desc ");
